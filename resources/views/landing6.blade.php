    ...
    <section id="hitung-cepat" class="py-24 bg-white border-y border-blue-50">
        <div class="container mx-auto px-6">
            ...
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col lg:flex-row border border-blue-100">
                <div class="lg:w-7/12 p-8 lg:p-12 bg-blue-50" x-data="{ luas: '', harga: 5500000, tipe: 'sederhana' }">
                    <div class="space-y-6">
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-2">Pilih Permodelan Bangunan</label>
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <button @click="harga = 5500000; tipe='sederhana'" :class="{'bg-blue-100 border-blue-600 text-blue-700 ring-2 ring-blue-200': tipe==='sederhana', 'bg-white border-slate-200 text-slate-600 hover:border-blue-400': tipe!=='sederhana'}" class="p-4 border rounded-xl text-left transition relative overflow-hidden">
                                    <div class="font-bold relative z-10">Rumah Sederhana</div>
                                    <div class="text-xs mt-1 relative z-10">Rp 5.5 Jt / m²</div>
                                    <div x-show="tipe==='sederhana'" class="absolute right-0 top-0 p-1"><i class="fas fa-check-circle text-blue-600"></i></div>
                                </button>
                                <button @click="harga = 7500000; tipe='menengah'" :class="{'bg-blue-100 border-blue-600 text-blue-700 ring-2 ring-blue-200': tipe==='menengah', 'bg-white border-slate-200 text-slate-600 hover:border-blue-400': tipe!=='menengah'}" class="p-4 border rounded-xl text-left transition relative overflow-hidden">
                                    <div class="font-bold relative z-10">Rumah Menengah</div>
                                    <div class="text-xs mt-1 relative z-10">Rp 7.5 Jt / m²</div>
                                    <div x-show="tipe==='menengah'" class="absolute right-0 top-0 p-1"><i class="fas fa-check-circle text-blue-600"></i></div>
                                </button>
                                <button @click="harga = 12000000; tipe='mewah'" :class="{'bg-blue-100 border-blue-600 text-blue-700 ring-2 ring-blue-200': tipe==='mewah', 'bg-white border-slate-200 text-slate-600 hover:border-blue-400': tipe!=='mewah'}" class="p-4 border rounded-xl text-left transition relative overflow-hidden">
                                    <div class="font-bold relative z-10">Rumah Mewah</div>
                                    <div class="text-xs mt-1 relative z-10">Rp 12 Jt / m²</div>
                                    <div x-show="tipe==='mewah'" class="absolute right-0 top-0 p-1"><i class="fas fa-check-circle text-blue-600"></i></div>
                                </button>
                            </div>
                        </div>
                        <div>
