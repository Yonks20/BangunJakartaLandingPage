...
<body class="bg-blue-50 text-slate-800 antialiased">
    ...
    <section id="edukasi" class="py-24 bg-blue-50/50">
        <div class="container mx-auto px-6">
            ...
            <div x-data="{ tab: 'pelatihan' }">
                ...
                <div x-show="tab === 'pelatihan'" x-transition.opacity.duration.300ms>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div class="bg-white rounded-2xl p-6 shadow-sm border border-blue-50 hover:shadow-md transition">
                            <div class="flex justify-between items-start mb-4">
                                ...
                                <span class="text-slate-400 text-xs">10 Feb 2026</span>
                            </div>
                            <h3 class="font-bold text-lg text-slate-900 mb-2">Sertifikasi K3 Konstruksi</h3>
                            <div class="flex items-center gap-2 text-sm text-slate-500 mb-6"><i class="fas fa-map-marker-alt text-blue-500"></i> Jakarta Pusat</div>
                            <button class="w-full py-2 border border-blue-600 text-blue-600 rounded-lg font-semibold hover:bg-blue-50 transition">Daftar</button>
                        </div>
                        <div class="bg-white rounded-2xl p-6 shadow-sm border border-blue-50 hover:shadow-md transition">
                            <div class="flex justify-between items-start mb-4">
                                <span class="bg-yellow-100 text-yellow-700 text-xs font-bold px-2 py-1 rounded">Segera</span>
                                <span class="text-slate-400 text-xs">25 Feb 2026</span>
                            </div>
                            ...
                            <button class="w-full py-2 border border-blue-600 text-blue-600 rounded-lg font-semibold hover:bg-blue-50 transition">Detail</button>
                        </div>
                         <div class="bg-white rounded-2xl p-6 shadow-sm border border-blue-50 hover:shadow-md transition">
                            <div class="flex justify-between items-start mb-4">
                                <span class="bg-red-100 text-red-700 text-xs font-bold px-2 py-1 rounded">Tutup</span>
                                <span class="text-slate-400 text-xs">01 Feb 2026</span>
                            </div>
                            <h3 class="font-bold text-lg text-slate-900 mb-2">BIM Coordinator</h3>
                            <div class="flex items-center gap-2 text-sm text-slate-500 mb-6"><i class="fas fa-video text-blue-500"></i> Online Zoom</div>
                ...
                <div x-show="tab === 'webinar'" x-cloak class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-white rounded-2xl overflow-hidden shadow-sm border border-blue-50 flex">
                        ...
                        <div class="p-6 w-2/3">
                            <span class="text-blue-600 text-xs font-bold uppercase">Series #12</span>
                            <h3 class="font-bold text-lg text-slate-900 mt-1 mb-2">Green Building Jakarta</h3>
                     ...
                     <div class="bg-white rounded-2xl overflow-hidden shadow-sm border border-blue-50 flex">
                        ...
                        <div class="p-6 w-2/3">
                            <span class="text-blue-600 text-xs font-bold uppercase">Series #11</span>
                            <h3 class="font-bold text-lg text-slate-900 mt-1 mb-2">Digitalisasi Perizinan</h3>
                            <a href="#" class="text-sm font-semibold text-blue-600 hover:underline">Tonton Rekaman</a>
                        </div>
                    </div>
                </div>
    ...
    <section id="serba-serbi" class="py-24 bg-blue-50">
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <article class="bg-white rounded-2xl p-3 shadow-sm hover:shadow-md transition group cursor-pointer">
                    <div class="rounded-xl overflow-hidden mb-4 relative">
                        <img src="https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?q=80&w=600&auto=format&fit=crop" class="w-full h-40 object-cover group-hover:scale-105 transition duration-500">
                        <span class="absolute top-2 left-2 bg-blue-600 text-white px-2 py-0.5 rounded text-[10px] font-bold uppercase">Inovasi</span>
                    </div>
                    <div class="px-2 pb-2">
                        <div class="text-slate-400 text-xs mb-1">24 Jan 2026</div>
                        <h3 class="font-bold text-slate-900 text-sm leading-snug group-hover:text-blue-600 transition">Beton Ramah Lingkungan untuk Trotoar Jakarta</h3>
                    </div>
                </article>
                 <article class="bg-white rounded-2xl p-3 shadow-sm hover:shadow-md transition group cursor-pointer">
                    <div class="rounded-xl overflow-hidden mb-4 relative">
                        <img src="https://images.unsplash.com/photo-1590642916589-592bcaaa3e5a?q=80&w=600&auto=format&fit=crop" class="w-full h-40 object-cover group-hover:scale-105 transition duration-500">
                        <span class="absolute top-2 left-2 bg-blue-600 text-white px-2 py-0.5 rounded text-[10px] font-bold uppercase">Kompetisi</span>
                    </div>
                    <div class="px-2 pb-2">
                        <div class="text-slate-400 text-xs mb-1">22 Jan 2026</div>
                        <h3 class="font-bold text-slate-900 text-sm leading-snug group-hover:text-blue-600 transition">Pemenang Lomba Tenaga Kerja 2025</h3>
                    </div>
                </article>
                <article class="bg-white rounded-2xl p-3 shadow-sm hover:shadow-md transition group cursor-pointer">
                    <div class="rounded-xl overflow-hidden mb-4 relative">
                        <img src="https://images.unsplash.com/photo-1581092921461-eab62e97a780?q=80&w=600&auto=format&fit=crop" class="w-full h-40 object-cover group-hover:scale-105 transition duration-500">
                        <span class="absolute top-2 left-2 bg-blue-600 text-white px-2 py-0.5 rounded text-[10px] font-bold uppercase">Teknologi</span>
                    </div>
                    <div class="px-2 pb-2">
                        <div class="text-slate-400 text-xs mb-1">20 Jan 2026</div>
                        <h3 class="font-bold text-slate-900 text-sm leading-snug group-hover:text-blue-600 transition">Drone untuk Pemantauan Gedung Tinggi</h3>
                    </div>
                </article>
                 <article class="bg-white rounded-2xl p-3 shadow-sm hover:shadow-md transition group cursor-pointer">
                    <div class="rounded-xl overflow-hidden mb-4 relative">
                        <img src="https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?q=80&w=600&auto=format&fit=crop" class="w-full h-40 object-cover group-hover:scale-105 transition duration-500">
                        <span class="absolute top-2 left-2 bg-blue-600 text-white px-2 py-0.5 rounded text-[10px] font-bold uppercase">Regulasi</span>
                    </div>
                    <div class="px-2 pb-2">
                        <div class="text-slate-400 text-xs mb-1">18 Jan 2026</div>
                        <h3 class="font-bold text-slate-900 text-sm leading-snug group-hover:text-blue-600 transition">Aturan Baru Izin Mendirikan Bangunan 2026</h3>
                    </div>
                </article>
            </div>
        </div>
