...
<head>
    ...
    <style>
        ...
        /* Custom Scrollbar Hide (Optional) agar terlihat bersih saat di-scroll */
                    ...
                    <div class="space-y-6">
                        <div>
                            <div class="flex justify-between items-center mb-2">
                                ...
                                <span class="text-xs text-blue-500 font-medium"><i class="fas fa-arrows-alt-h mr-1"></i> Geser untuk pilihan lain</span>
                            </div>
                            ...
                            <div class="flex gap-4 overflow-x-auto pb-4 snap-x hide-scroll">
                                <template x-for="model in models" :key="model.id">
                                    <button @click="selectedModel = model" 
                                            ...
                                            class="flex-shrink-0 w-48 p-4 border rounded-xl text-left transition relative overflow-hidden snap-start">
        ...
        <div class="container mx-auto px-6">
            ...
            <div x-data="{ tab: 'jadwal' }">
                ...
                <div x-show="tab === 'jadwal'" x-transition.opacity.duration.300ms>
                    <div class="flex justify-between items-center mb-2 px-2 md:hidden">
                        <span class="text-xs text-blue-500 font-medium"><i class="fas fa-arrows-alt-h mr-1"></i> Geser kartu</span>
                    </div>
                    <div class="flex gap-6 overflow-x-auto pb-6 snap-x hide-scroll">
                        <div class="bg-white rounded-2xl p-6 shadow-sm border border-blue-50 hover:shadow-md transition min-w-[300px] w-full md:w-1/3 flex-shrink-0 snap-center">
